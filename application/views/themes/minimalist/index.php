...
<head>
    <meta charset="utf-8">
    <title><?= html_escape($page_title ?? ($project->title ?? 'Undangan Acara')); ?></title>
    ...
    <?php
    $title = !empty($project->title) ? $project->title : 'Undangan Acara';
    $subtitle = !empty($project->subtitle) ? $project->subtitle : 'Special Event Invitation';
    $coverText = !empty($project->cover_text) ? $project->cover_text : 'Dengan penuh hormat kami mengundang Bapak/Ibu/Saudara/i untuk hadir dalam acara kami';
    $description = !empty($project->description) ? $project->description : 'Dengan penuh kebahagiaan, kami mengundang Bapak/Ibu/Saudara/i untuk hadir dan menjadi bagian dari momen istimewa ini.';
    $messageTitle = !empty($project->message_title) ? $project->message_title : 'Kehadiran Anda Berarti';
    $messageBody = !empty($project->message_body) ? $project->message_body : 'Kehadiran, doa, dan dukungan Bapak/Ibu/Saudara/i akan menjadi kehormatan serta kebahagiaan bagi kami.';
    $mainName = !empty($project->receiver_name) ? $project->receiver_name : (!empty($project->title) ? $project->title : 'Tamu Spesial');
    $hostName = !empty($project->sender_name) ? $project->sender_name : 'Penyelenggara Acara';
    ...
    <style>
        :root {
            ...
            --paper: #ffffff;
            --muted: #687086;
            --line: rgba(91, 111, 166, .16);
            --shadow: 0 28px 80px rgba(31, 43, 69, .16);
        }
        ...
        * {
        ...
        body {
            ...
            background:
                ...
                radial-gradient(circle at 90% 10%, rgba(91, 111, 166, .12), transparent 30%),
                linear-gradient(180deg, #f7f5ff 0%, #eef3ff 100%);
            overflow-x: hidden;
        }
        ...
        .topbar {
            ...
            box-shadow: 0 18px 50px rgba(31, 43, 69, .09);
        }
        ...
        .hero-card {
            ...
            border: 1px solid rgba(91, 111, 166, .12);
        }
        ...
        .guest-pill {
            ...
            color: var(--deep);
            font-weight: 800;
            box-shadow: 0 14px 35px rgba(31, 43, 69, .08);
        }
        ...
        .visual-overlay {
            ...
            inset: 0;
            background:
                linear-gradient(180deg, rgba(31, 43, 69, .02), rgba(31, 43, 69, .82)),
                radial-gradient(circle at center, transparent 20%, rgba(31, 43, 69, .35) 100%);
        }
        ...
        .card-soft {
            ...
            border-radius: 34px;
            padding: 32px;
            box-shadow: 0 24px 70px rgba(31, 43, 69, .09);
        }
        ...
        .icon-round {
            ...
            font-size: 22px;
            margin-bottom: 18px;
            box-shadow: 0 16px 34px rgba(91, 111, 166, .2);
        }
        ...
        .count-item {
            ...
            padding: 24px 12px;
            text-align: center;
            box-shadow: 0 18px 45px rgba(31, 43, 69, .08);
        }
        ...
        .form-select:focus {
            ...
            box-shadow: 0 0 0 .2rem rgba(91, 111, 166, .12);
        }
        ...
        .wish-card {
            ...
            border-radius: 28px;
            padding: 24px;
            box-shadow: 0 18px 48px rgba(31, 43, 69, .07);
            height: 100%;
        }
        ...
        .music-btn {
            ...
            place-items: center;
            font-size: 25px;
            box-shadow: 0 18px 45px rgba(31, 43, 69, .26);
        }
...
<body>
    <div class="page">
        ...
        <header class="topbar">
            <div class="brand-mini"><span>✦</span> Special Event</div>
            <nav class="nav-mini">
                        ...
                        <div class="col-lg-5">
                            <div class="hero-visual">
                                ...
                                <div class="visual-caption">
                                    <h2>Momen Spesial</h2>
                                    <p>Kehadiran Bapak/Ibu/Saudara/i akan menjadi bagian indah dari acara dan kebersamaan kami.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section section-sm" id="detail">
            <div class="container">
                <div class="section-head text-center">
                    ...
                    <p class="section-subtitle">Kami mengharapkan kehadiran Bapak/Ibu/Saudara/i pada detail acara berikut.</p>
                </div>
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card-soft">
            ...
            <div class="container">
                <div class="message-panel">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-5">
                            <span class="kicker"><i class="bi bi-stars"></i> Pesan Acara</span>
                            <h2 class="section-title"><?= html_escape($messageTitle); ?></h2>
                        </div>
                        <div class="col-lg-7">
                            <p class="mb-0"><?= nl2br(html_escape($messageBody)); ?></p>
                            <p class="mt-4 mb-0">Salam hangat,<br><strong><?= html_escape($hostName); ?></strong></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section class="section" id="gallery">
                <div class="container">
                    <div class="section-head text-center">
                        ...
                        <p class="section-subtitle">Beberapa momen pilihan yang menjadi bagian dari cerita acara ini.</p>
                    </div>
                    <div class="gallery-grid">
                        <?php foreach ($galleries as $gallery): ?>
                            ...
                            if (!empty($gallery->image_path)) {
                                $galleryImage = asset_or_url($gallery->image_path);
                            } elseif (!empty($gallery->image)) {
                                $galleryImage = asset_or_url($gallery->image);
                            } elseif (!empty($gallery->photo)) {
                                $galleryImage = asset_or_url($gallery->photo);
                            } elseif (!empty($gallery->foto)) {
                                $galleryImage = asset_or_url($gallery->foto);
                            }
                            ?>
                            <?php if (!empty($galleryImage)): ?>
                                <div class="gallery-item">
                                    <img src="<?= html_escape($galleryImage); ?>" alt="<?= html_escape(!empty($gallery->caption) ? $gallery->caption : 'Galeri Acara'); ?>">
                                    <?php if (!empty($gallery->caption)): ?>
                                        <div class="gallery-caption"><?= html_escape($gallery->caption); ?></div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-7">
                            <div class="map-frame-wrap">
                                ...
                                <?php else: ?>
                                    <div class="map-empty">
                                        <div><i class="bi bi-geo-alt fs-1 d-block mb-3"></i>Maps belum tersedia.</div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <section class="section section-sm" id="rsvp">
                <div class="container">
                    <div class="section-head text-center">
                        ...
                        <p class="section-subtitle">Mohon berkenan mengisi konfirmasi kehadiran agar acara dapat dipersiapkan dengan baik.</p>
                    </div>
                    <div class="card-soft">
                        <form method="post" action="<?= site_url('rsvp/store'); ?>" class="row g-3">
                            ...
                            <div class="col-md-4"><label class="form-label">Kehadiran</label><select name="status" class="form-select" required>
        ...
        <?php if (!empty($project->wish_enabled) || isset($wishes)): ?>
            <section class="section section-sm" id="wishes">
                <div class="container">
                    <div class="section-head text-center">
                        <span class="kicker"><i class="bi bi-chat-heart"></i> Ucapan & Harapan</span>
                        <h2 class="section-title">Kirim Ucapan</h2>
                        <p class="section-subtitle">Tuliskan ucapan, harapan, atau pesan terbaik untuk acara ini.</p>
                    </div>
                    <div class="card-soft mb-4">
                        <form method="post" action="<?= site_url('wish/store'); ?>" class="row g-3">
                            ...
                            <div class="col-md-8"><label class="form-label">Ucapan / Pesan</label><input name="message" class="form-control" placeholder="Tulis ucapan terbaik Anda" required></div>
        ...
        <section class="section section-sm">
            <div class="container">
                <div class="card-soft text-center">
                    ...
                    <p class="section-subtitle mb-4">Kirim link undangan ini kepada keluarga, teman, dan tamu undangan.</p>
                    <div class="share-box">
        ...
        <section class="section section-sm">
            <div class="container text-center">
                <div class="footer-soft">Terima kasih atas perhatian, waktu, dan kehadiran Anda.</div>
            </div>
        </section>
    </div>
