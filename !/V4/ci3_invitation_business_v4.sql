...
INSERT INTO `activity_logs` (`user_id`, `module`, `action`, `description`, `created_at`) VALUES
(1, 'system', 'seed', 'Database V4 berhasil di-seed', NOW());

INSERT INTO `settings` (`setting_key`, `setting_value`) VALUES
('brand_name', 'InviteBiz'),
('wa_number', '6281234567890');

INSERT INTO `product_types` (`id`, `name`, `code`, `description`, `is_active`, `sort_order`, `created_at`) VALUES
(1, 'Wedding Invitation', 'wedding', 'Undangan digital untuk pernikahan', 1, 1, NOW()),
(2, 'Greeting Card', 'greeting_card', 'Kartu ucapan digital', 1, 2, NOW());

INSERT INTO `templates` (`id`, `name`, `folder`, `product_type`, `thumbnail`, `description`, `demo_url`, `sort_order`, `is_active`, `created_at`) VALUES
(1, 'Romantic Wedding', 'romantic', 'wedding', 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=900&q=80', 'Tampilan clean dan elegan untuk wedding invitation.', 'http://localhost/ci3_invitation_business_v3/preview/amel-budi', 1, 1, NOW()),
(2, 'Floral Wedding', 'floral', 'wedding', 'https://images.unsplash.com/photo-1525258946800-98cfd641d0de?auto=format&fit=crop&w=900&q=80', 'Warna lembut dengan info acara dan RSVP.', 'http://localhost/ci3_invitation_business_v3/preview/amel-budi', 2, 1, NOW()),
(3, 'Greeting Special', 'greeting', 'greeting_card', 'https://images.unsplash.com/photo-1513151233558-d860c5398176?auto=format&fit=crop&w=900&q=80', 'Cocok untuk birthday, anniversary, dan ucapan spesial.', 'http://localhost/ci3_invitation_business_v3/card/happy-birthday-bella', 1, 1, NOW());
