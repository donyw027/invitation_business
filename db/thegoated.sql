...
-- Dumping data for table ci3_invitation_business_v3.customers: ~11 rows (approximately)
...
INSERT INTO `orders` (`id`, `order_no`, `customer_id`, `product_type`, `package_name`, `template_id`, `assigned_user_id`, `payment_status`, `status`, `price`, `discount`, `final_price`, `dp_amount`, `paid_amount`, `payment_method`, `payment_date`, `deadline_date`, `payment_proof`, `notes`, `created_at`) VALUES
	(1, 'ORD-20260401-0001', 1, 'invitation', 'Exclusive', 1, 3, 'paid', 'in_progress', 199000, 10000, 189000, 50000, 189000, 'bank_transfer', '2026-04-01', '2026-04-10', 'uploads/payments/order1.jpg', 'Wedding invitation untuk akad dan resepsi.', '2026-04-01 09:30:00'),
	(2, 'ORD-20260401-0002', 2, 'invitation', 'Premium', 2, 3, 'paid', 'completed', 129000, 0, 129000, 50000, 129000, 'qris', '2026-04-01', '2026-04-08', 'uploads/payments/order2.jpg', 'Undangan floral untuk intimate wedding.', '2026-04-01 10:00:00'),
	(3, 'ORD-20260402-0001', 3, 'invitation', 'Premium', 3, 2, 'paid', 'in_progress', 129000, 5000, 124000, 40000, 124000, 'bank_transfer', '2026-04-02', '2026-04-12', 'uploads/payments/order3.jpg', 'Birthday invitation untuk ulang tahun ke-7.', '2026-04-02 08:45:00'),
	(4, 'ORD-20260402-0002', 4, 'invitation', 'Exclusive', 4, 3, 'paid', 'in_progress', 199000, 15000, 184000, 75000, 184000, 'ewallet', '2026-04-02', '2026-04-13', 'uploads/payments/order4.jpg', 'Undangan khitan dengan RSVP aktif.', '2026-04-02 09:20:00'),
	(5, 'ORD-20260402-0003', 5, 'invitation', 'Basic', 5, 2, 'paid', 'completed', 79000, 0, 79000, 30000, 79000, 'cash', '2026-04-02', '2026-04-06', 'uploads/payments/order5.jpg', 'Tahlil 7 hari, desain clean.', '2026-04-02 10:05:00'),
	(6, 'ORD-20260403-0001', 6, 'greeting_card', 'Greeting Basic', 6, 2, 'paid', 'completed', 49000, 0, 49000, 0, 49000, 'qris', '2026-04-03', '2026-04-04', 'uploads/payments/order6.jpg', 'Greeting untuk ulang tahun sahabat.', '2026-04-03 09:00:00'),
	(7, 'ORD-20260403-0002', 7, 'greeting_card', 'Greeting Special', 7, 3, 'paid', 'in_progress', 69000, 0, 69000, 20000, 69000, 'bank_transfer', '2026-04-03', '2026-04-05', 'uploads/payments/order7.jpg', 'Greeting bear untuk ucapan semangat.', '2026-04-03 09:30:00'),
	(8, 'ORD-20260403-0003', 8, 'greeting_card', 'Greeting Deluxe', 8, 3, 'paid', 'completed', 89000, 10000, 79000, 30000, 79000, 'qris', '2026-04-03', '2026-04-06', 'uploads/payments/order8.jpg', 'Greeting blossom premium.', '2026-04-03 10:00:00'),
	(9, 'ORD-20260403-0004', 9, 'greeting_card', 'Greeting Special', 9, 2, 'paid', 'completed', 69000, 0, 69000, 20000, 69000, 'bank_transfer', '2026-04-03', '2026-04-05', 'uploads/payments/order9.jpg', 'Greeting polaroid untuk anniversary ke-3.', '2026-04-03 10:20:00'),
	(10, 'ORD-20260404-0001', 10, 'greeting_card', 'Greeting Basic', 10, 2, 'paid', 'completed', 49000, 0, 49000, 0, 49000, 'ewallet', '2026-04-04', '2026-04-05', 'uploads/payments/order10.jpg', 'Greeting sunflower untuk bestie.', '2026-04-04 08:15:00'),
	(11, 'ORD-20260404-0002', 11, 'greeting_card', 'Greeting Deluxe', 11, 3, 'paid', 'in_progress', 89000, 5000, 84000, 30000, 84000, 'bank_transfer', '2026-04-04', '2026-04-07', 'uploads/payments/order11.jpg', 'Greeting bunny premium untuk anniversary.', '2026-04-04 09:10:00');
...
-- Dumping data for table ci3_invitation_business_v3.project_galleries: ~10 rows (approximately)
...
-- Dumping data for table ci3_invitation_business_v3.project_timelines: ~0 rows (approximately)
INSERT INTO `project_timelines` (`id`, `project_id`, `user_id`, `status_label`, `note`, `approval_status`, `approved_by`, `approved_at`, `created_at`) VALUES
	(1, 1, 3, 'Draft Awal', 'Konten awal wedding sudah dimasukkan sesuai brief customer.', 'approved', 1, '2026-04-02 15:10:00', '2026-04-02 14:45:00'),
	(2, 1, 2, 'Revisi', 'Menyesuaikan jam resepsi dan gift info.', 'approved', 1, '2026-04-03 14:15:00', '2026-04-03 13:50:00'),
	(3, 2, 3, 'Published', 'Project floral sudah dipublish dan link dikirim ke customer.', 'approved', 1, '2026-04-02 16:12:00', '2026-04-02 16:10:00'),
	(4, 3, 2, 'Konten Masuk', 'Data birthday dan daftar tamu sudah lengkap.', 'approved', 1, '2026-04-03 11:25:00', '2026-04-03 11:20:00'),
	(5, 4, 3, 'Revisi', 'Customer meminta penambahan gift info dan pembetulan nama venue.', 'approved', 1, '2026-04-04 10:35:00', '2026-04-04 10:30:00'),
	(6, 5, 2, 'Published', 'Undangan tahlil sudah dikirim ke keluarga inti.', 'approved', 1, '2026-04-03 19:15:00', '2026-04-03 19:10:00'),
	(7, 8, 3, 'Final Check', 'Greeting blossom sudah final dan siap dibagikan.', 'approved', 1, '2026-04-04 13:15:00', '2026-04-04 13:10:00'),
	(8, 11, 3, 'Final Check', 'Sunny bunny sudah publish dengan musik aktif.', 'approved', 1, '2026-04-05 09:32:00', '2026-04-05 09:30:00');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `role`, `photo`, `is_active`, `last_login_at`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Rina Customer Service', 'cs', 'cs@example.com', '$2y$12$Mif.oYTiZ1LCKYtg73M/jOTEkdLNJS6WlzFbuXSQLHMX1toxPAt/6', 'admin', '', 1, '2026-04-04 16:12:10', '2026-03-31 08:05:00', '2026-03-31 08:05:00'),
	(3, 'Dimas Designer', 'designer', 'designer@example.com', '$2y$12$Mif.oYTiZ1LCKYtg73M/jOTEkdLNJS6WlzFbuXSQLHMX1toxPAt/6', 'admin', '', 1, '2026-04-05 08:44:03', '2026-03-31 08:10:00', '2026-03-31 08:10:00');
