...
-- Dumping data for table ci3_invitation_business_v3.activity_logs: ~5 rows (approximately)
...
-- Dumping data for table ci3_invitation_business_v3.customers: ~1 rows (approximately)
...
-- Dumping data for table ci3_invitation_business_v3.orders: ~16 rows (approximately)
...
-- Dumping data for table ci3_invitation_business_v3.projects: ~16 rows (approximately)
...
-- Dumping data for table ci3_invitation_business_v3.templates: ~16 rows (approximately)
INSERT INTO `templates` (`id`, `name`, `folder`, `product_type`, `thumbnail`, `description`, `preview_mobile`, `preview_desktop`, `demo_url`, `sort_order`, `is_active`, `created_at`) VALUES
	...
	(12, 'Graduation', 'graduation', 'invitation', 'https://images.unsplash.com/photo-1464349153735-7db50ed83c84?auto=format&fit=crop&w=900&q=80', 'Tema invitation Graduation', 'https://images.unsplash.com/photo-1464349153735-7db50ed83c84?auto=format&fit=crop&w=500&q=80', 'https://images.unsplash.com/photo-1464349153735-7db50ed83c84?auto=format&fit=crop&w=1200&q=80', 'i/demo-graduation', 3, 1, '2026-05-16 03:32:01'),
	(13, 'Greeting Claudy', 'greeting_claudy', 'greeting_card', 'https://images.unsplash.com/photo-1518199266791-5375a83190b7?auto=format&fit=crop&w=900&q=80', 'Greeting card Claudy dengan Awan-Awan manis.', 'https://images.unsplash.com/photo-1518199266791-5375a83190b7?auto=format&fit=crop&w=500&q=80', 'https://images.unsplash.com/photo-1518199266791-5375a83190b7?auto=format&fit=crop&w=1200&q=80', 'i/demo-greeting-claudy', 8, 1, '2026-05-16 05:57:03'),
	(14, 'Doa Bersama', 'doa', 'invitation', 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=900&q=80', 'Tema invitation Doa Bersama, sopan, dan Minimalist.', 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=500&q=80', 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=1200&q=80', 'i/demo-doa', 5, 1, '2026-05-16 06:37:59'),
	(16, 'Black', 'black', 'invitation', 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=900&q=80', 'Tema wedding elegan dengan pasangan, bunga, dan nuansa romantis.', 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=500&q=80', 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=1200&q=80', 'i/demo-black', 1, 1, '2026-05-16 06:39:03'),
	(17, 'Minimalist', 'minimalist', 'invitation', 'https://images.unsplash.com/photo-1520854221256-17451cc331bf?auto=format&fit=crop&w=900&q=80', 'Tema undangan keren untuk acara apapun.', 'https://images.unsplash.com/photo-1520854221256-17451cc331bf?auto=format&fit=crop&w=500&q=80', 'https://images.unsplash.com/photo-1520854221256-17451cc331bf?auto=format&fit=crop&w=1200&q=80', 'i/demo-minimalist', 2, 1, '2026-05-16 06:39:54');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `role`, `photo`, `is_active`, `last_login_at`, `created_at`, `updated_at`) VALUES
	...
	(5, 'doni', 'doni', 'doniwicaksono27@gmail.com', '$2y$10$Y/lSRl.JBns7nuRIkDhOHuuPhU6/CLlvtNtcFEV52lOeTUn0y6xjC', 'super_admin', '', 1, '2026-05-16 04:47:29', '2026-05-05 12:05:54', '2026-05-05 12:05:54');
...
-- Dumping data for table ci3_invitation_business_v3.wishes: ~16 rows (approximately)
