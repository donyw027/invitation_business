...
-- Dumping data for table ci3_invitation_business_v3.activity_logs: ~39 rows (approximately)
...
INSERT INTO `customers` (`id`, `name`, `phone`, `email`, `source`, `address`, `notes`, `created_at`) VALUES
	...
	(12, 'sasa', '081238390383393', 'sasa@gmail.com', 'sasaaaappp', 'Jl.Borobudur', 'Greeting Card', '2026-04-12 10:39:06'),
	(13, 'linda', '0892819192922', 'lindaa@gmail.com', '', 'Jl.semangka', 'invitation', '2026-04-12 10:39:38');
...
INSERT INTO `orders` (`id`, `order_no`, `customer_id`, `product_type`, `package_name`, `template_id`, `assigned_user_id`, `payment_status`, `status`, `price`, `discount`, `final_price`, `dp_amount`, `paid_amount`, `payment_method`, `payment_date`, `deadline_date`, `payment_proof`, `notes`, `created_at`) VALUES
	(1, 'ORD-20260401-0001', 1, 'invitation', 'Exclusive', 1, NULL, 'paid', 'in_progress', 199000, 10000, 189000, 50000, 189000, 'bank_transfer', '2026-04-01', '2026-04-10', 'uploads/payments/order1.jpg', 'Wedding invitation untuk akad dan resepsi.', '2026-04-01 09:30:00'),
	(2, 'ORD-20260401-0002', 2, 'invitation', 'Premium', 2, NULL, 'paid', 'completed', 129000, 0, 129000, 50000, 129000, 'qris', '2026-04-01', '2026-04-08', 'uploads/payments/order2.jpg', 'Undangan floral untuk intimate wedding.', '2026-04-01 10:00:00'),
	(3, 'ORD-20260402-0001', 3, 'invitation', 'Premium', 3, NULL, 'paid', 'in_progress', 129000, 5000, 124000, 40000, 124000, 'bank_transfer', '2026-04-02', '2026-04-12', 'uploads/payments/order3.jpg', 'Birthday invitation untuk ulang tahun ke-7.', '2026-04-02 08:45:00'),
	(4, 'ORD-20260402-0002', 4, 'invitation', 'Exclusive', 4, NULL, 'paid', 'in_progress', 199000, 15000, 184000, 75000, 184000, 'ewallet', '2026-04-02', '2026-04-13', 'uploads/payments/order4.jpg', 'Undangan khitan dengan RSVP aktif.', '2026-04-02 09:20:00'),
	(5, 'ORD-20260402-0003', 5, 'invitation', 'Basic', 5, NULL, 'paid', 'completed', 79000, 0, 79000, 30000, 79000, 'cash', '2026-04-02', '2026-04-06', 'uploads/payments/order5.jpg', 'Tahlil 7 hari, desain clean.', '2026-04-02 10:05:00'),
	(6, 'ORD-20260403-0001', 6, 'greeting_card', 'Greeting Basic', 6, NULL, 'paid', 'completed', 49000, 0, 49000, 0, 49000, 'qris', '2026-04-03', '2026-04-04', 'uploads/payments/order6.jpg', 'Greeting untuk ulang tahun sahabat.', '2026-04-03 09:00:00'),
	(7, 'ORD-20260403-0002', 7, 'greeting_card', 'Greeting Special', 7, NULL, 'paid', 'in_progress', 69000, 0, 69000, 20000, 69000, 'bank_transfer', '2026-04-03', '2026-04-05', 'uploads/payments/order7.jpg', 'Greeting bear untuk ucapan semangat.', '2026-04-03 09:30:00'),
	(8, 'ORD-20260403-0003', 8, 'greeting_card', 'Greeting Deluxe', 8, NULL, 'paid', 'completed', 89000, 10000, 79000, 30000, 79000, 'qris', '2026-04-03', '2026-04-06', 'uploads/payments/order8.jpg', 'Greeting blossom premium.', '2026-04-03 10:00:00'),
	(9, 'ORD-20260403-0004', 9, 'greeting_card', 'Greeting Special', 9, NULL, 'paid', 'completed', 69000, 0, 69000, 20000, 69000, 'bank_transfer', '2026-04-03', '2026-04-05', 'uploads/payments/order9.jpg', 'Greeting polaroid untuk anniversary ke-3.', '2026-04-03 10:20:00'),
	(10, 'ORD-20260404-0001', 10, 'greeting_card', 'Greeting Basic', 10, NULL, 'paid', 'completed', 49000, 0, 49000, 0, 49000, 'ewallet', '2026-04-04', '2026-04-05', 'uploads/payments/order10.jpg', 'Greeting sunflower untuk bestie.', '2026-04-04 08:15:00'),
	(11, 'ORD-20260404-0002', 11, 'greeting_card', 'Greeting Deluxe', 11, NULL, 'paid', 'in_progress', 89000, 5000, 84000, 30000, 84000, 'bank_transfer', '2026-04-04', '2026-04-07', 'uploads/payments/order11.jpg', 'Greeting bunny premium untuk anniversary.', '2026-04-04 09:10:00'),
	(12, 'ORD-20260412-0001', 13, 'invitation', 'Premium', 2, 4, 'paid', 'in_progress', 100000, 0, 100000, 0, 100000, 'bank_transfer', '2026-04-12', '2026-04-24', '', '', '2026-04-12 10:43:11'),
	(15, 'ORD-20260412-0002', 12, 'greeting_card', 'Premium', 7, 4, 'paid', 'in_progress', 6, 0, 6, 0, 6, 'bank_transfer', '2026-04-19', '2026-04-13', '', '', '2026-04-12 10:53:11');
...
-- Dumping data for table ci3_invitation_business_v3.projects: ~13 rows (approximately)
INSERT INTO `projects` (`id`, `order_id`, `source`, `product_type`, `template_id`, `assigned_user_id`, `slug`, `title`, `subtitle`, `cover_text`, `hero_image`, `music_url`, `event_date`, `event_time`, `deadline_date`, `location_name`, `location_address`, `map_embed`, `description`, `sender_name`, `receiver_name`, `message_title`, `message_body`, `rsvp_enabled`, `wish_enabled`, `gift_enabled`, `gift_info`, `revision_notes`, `status`, `created_at`, `updated_at`) VALUES
	...
	(12, 12, 'order_auto', 'invitation', 2, 4, 'linda-ord-20260412-0001', 'Invitation - linda', 'Undangan Pernikahan', 'Kepada Yth. Bapak/Ibu/Saudara/i', 'uploads/projects/cdff67c0becc39bdfc4b4c18d32d3536.jpg', '', '2026-04-12', '10 : 00', '2026-04-24', 'wkwkkwkw', 'Jl.boro', '', 'Deskripsi story', 'Sender name', 'receiver', 'Message title', 'ucapan', 0, 1, 1, 'Info gift', 'Auto dibuat dari order paid: ORD-20260412-0001 | Template: Floral Wedding', 'published', '2026-04-12 10:43:12', '2026-04-12 10:49:39'),
	(13, 15, 'order_auto', 'greeting_card', 9, 4, 'sasa-ord-20260412-0002', 'Greeting Card - sasa', 'Selamat Ulang Tahun', 'A special cardst for you', 'uploads/projects/0566b70fa1569bad12a708daf1ebde60.jpg', '', NULL, '', '2026-04-13', '', '', '', 'blabalaa', 'ind', 'sasa', 'A Special Greeting', 'mdhjdhdudddjhjdh', 0, 1, 0, '', 'Auto dibuat dari order paid: ORD-20260412-0002 | Template: Greeting Bear', 'waiting_content', '2026-04-12 10:53:13', '2026-04-12 10:57:30');
...
INSERT INTO `project_galleries` (`id`, `project_id`, `image_path`, `caption`, `sort_order`, `created_at`) VALUES
	...
	(12, 12, 'uploads/projects/gallery/50f96949c59381bba9aa28df189f3249.png', '', 1, '2026-04-12 10:49:11'),
	(13, 12, 'uploads/projects/gallery/fd184ff357748b3daf755bf37a2a3245.jpg', '', 2, '2026-04-12 10:49:34');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `role`, `photo`, `is_active`, `last_login_at`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'admin', 'admin@example.com', '$2y$12$Mif.oYTiZ1LCKYtg73M/jOTEkdLNJS6WlzFbuXSQLHMX1toxPAt/6', 'super_admin', '', 1, '2026-05-05 11:36:34', '2026-03-31 08:00:00', '2026-03-31 08:00:00'),
...
INSERT INTO `wishes` (`id`, `project_id`, `guest_name`, `message`, `status`, `is_approved`, `created_at`) VALUES
	...
	(16, 12, 'doni', 'semoga bahagia', 'approved', 1, '2026-04-12 10:50:15');
