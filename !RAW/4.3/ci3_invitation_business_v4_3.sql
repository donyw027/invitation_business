...
INSERT INTO `project_timelines` (`project_id`, `user_id`, `status_label`, `note`, `created_at`) VALUES (1, 2, 'Kickoff', 'Project dibuat dan menunggu revisi cover photo dari client.', NOW()), (1, 2, 'Revision', 'Client minta update gift info dan foto cover.', NOW());
